...
1.1 [Option A: To use the local Azure Cosmos DB Emulator] If you haven't already done so, download and install the emulator (https://learn.microsoft.com/en-us/azure/cosmos-db/local-emulator). Run the Emulator locally and the Cosmos DB Emulator explorer will open in a browser tab. From here you can access the URI and primary key of your emulated Cosmos DB required in step 3.

1.2 [Option B: To use a real Cosmos DB in Azure] If you haven't already done so, in the Azure Portal create an Azure Cosmos DB (use 'Serverless' to save costs).
